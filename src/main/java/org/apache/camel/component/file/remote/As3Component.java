...
public class As3Component extends GenericFileComponent<S3Object> {
	...
	public As3Component(CamelContext camelContext) {
		super(camelContext);
	}

	@Override
	protected void afterPropertiesSet(GenericFileEndpoint<S3Object> endpoint)
			throws Exception {
	}

	@Override
	protected GenericFileEndpoint<S3Object> buildFileEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
     ...
     */
    protected void extractAndSetFtpClientConfigParameters(Map<String, Object> parameters, As3Endpoint<S3Object> answer) {
     ...
     * when creating a client.
     */
    protected void extractAndSetFtpClientParameters(Map<String, Object> parameters, As3Endpoint<S3Object> answer) {
